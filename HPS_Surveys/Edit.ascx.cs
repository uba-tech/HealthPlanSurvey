/*
' Copyright (c) 2016  ubabenefits.com
'  All rights reserved.
' 
...
using UBA.Modules.HPS_Surveys.Components;
using DotNetNuke.Services.Exceptions;

namespace UBA.Modules.HPS_Surveys
{
    /// -----------------------------------------------------------------------------
    /// <summary>   
    ...
    /// 
    /// Because the control inherits from HPS_SurveysModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Edit : HPS_SurveysModuleBase
    {
