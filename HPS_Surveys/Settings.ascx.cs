...
namespace UBA.Modules.HPS_Surveys
{
    ...
    /// 
    /// Because the control inherits from HPS_SurveysSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : HPS_SurveysModuleSettingsBase
    {
