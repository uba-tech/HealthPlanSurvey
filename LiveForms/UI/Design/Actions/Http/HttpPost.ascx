...
<div class="LiveForm">
    ...
    <table width="100%">
        <tr>
            <td width="150px">
                <dnn:Label ID="lTokenPrefix" runat="server"></dnn:Label>
            </td>
            <td>
                <asp:TextBox ID="tbTokenPrefix" runat="server" Width="250px" Text=""></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td width="150px">
        ...
        <tr>
            ...
            <td>
                ...
                <div>
                    <asp:Label ID="Noteinfo" runat="server" Resourcekey="lNoteInfo" /></div>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
