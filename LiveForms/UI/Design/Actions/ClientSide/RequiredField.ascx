<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RequiredField.ascx.cs" Inherits="Mandeeps.DNN.Modules.LiveForms.UI.Design.Actions.ClientSide.RequiredField" %>
    ...
    <table style="background-color: lightgray; padding: 8px; width: 100%; margin-bottom:10px;">
        ...
        <tr>
            <td style="width: 50px; padding-left: 6px;">
                <asp:DropDownList ID="ddlRequire" onchange="Conditions.ClearIndex();" runat="server" AutoPostBack="true"></asp:DropDownList></td>
            <td>
