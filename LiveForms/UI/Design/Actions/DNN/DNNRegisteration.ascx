...
<div class="LiveForm">
    ...
    <table width="100%">
        <tr>
            <td colspan="2">
                <asp:Label ID="lRegistrationHeading" runat="server" ResourceKey="lRegistrationHeading" Font-Bold="true"></asp:Label><hr />
            </td>
        </tr>
        <tr>
            <td width="300px">
        ...
        <tr>
            <td width="300px">
                <dnn:Label ID="lRedirectAfterRegistration" runat="server" ResourceKey="lRedirectAfterRegistration" Font-Bold="true"></dnn:Label>
            </td>
            <td>
                <asp:CheckBox ID="cbRedirectAfterRegistration" Checked="true" runat="server" />
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="lProfileHeading" runat="server" ResourceKey="lProfileHeading" Font-Bold="true"></asp:Label><hr />
            </td>
        </tr>
    </table>
    <asp:PlaceHolder ID="ProfileOptions" runat="server"></asp:PlaceHolder>
    <table width="100%">
        <tr>
            <td colspan="2">
                <div class="caption">
