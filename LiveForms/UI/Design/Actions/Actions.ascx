...
<div class="LiveForm FormVerticalTabs">
    <Mandeeps:TabStrip runat="server" ID="VerticalTabs" TabsPersistence="true" SelectedIndex="0" Theme="Vertical"
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        <br />
                        <span class="clientradiospan">Bind or update a field by executing a SQL Query; optionally based on another field</span>
                    </li>
                     <li>
                        <asp:RadioButton ID="rbBindFormSQLQuery" runat="server" Text="" GroupName="rbClientSide" AutoPostBack="true" OnCheckedChanged="rbBindFormSQLQuery_CheckedChanged" /><asp:Label ID="Label2" runat="server" Resourcekey="lBindFormSQLQuery" />
                        <br />
                        <span class="clientradiospan">Bind multiple fields by executing a SQL Query</span>
                    </li>
                </ul>
            </div>
        ...
        <Mandeeps:Tab ID="OnFormValidation" runat="server">
            <div class="caption">
                <asp:Label ID="lValidationInfo" runat="server" Resourcekey="lValidationInfo" />
            </div>
            <div>
                <ul>
                    <li>
                        <asp:RadioButton ID="rbExecuteSQL" runat="server" Text="" GroupName="rbValidation" AutoPostBack="true" OnCheckedChanged="rbExecuteSQL_CheckedChanged" /><asp:Label ID="Label3" runat="server" Resourcekey="lbrbExecuteSQL" />
                        <br />
                        <span class="clientradiospan">Execute a SQL Query or Stored Procedure to run custom validation logic and return a validated output.</span>
                    </li>
                    <li>
                        <asp:RadioButton ID="rbCompareFields" runat="server" Text="" GroupName="rbValidation" AutoPostBack="true" OnCheckedChanged="rbCompareFields_CheckedChanged"/><asp:Label ID="Label4" runat="server" Resourcekey="lCompareFields" />
                        <br />
                        <span class="clientradiospan">Compare the values of two fields using several pre-defined comparators.</span>
                    </li>
                </ul>
            </div>
            <telerik:radgrid id="gvValidationActions" style="width: 99%; overflow-x: auto;" runat="server"
                allowpaging="True" allowsorting="True" autogeneratecolumns="false" gridlines="None"
                onneeddatasource="gvValidationActions_NeedDataSource" onitemdatabound="gvValidationActions_ItemDataBound" OnDeleteCommand="gvValidationActions_DeleteCommand">
                <mastertableview datakeynames="GUID" nomasterrecordstext="Looks like you have not created any Validation action!">
                    <RowIndicatorColumn>
                        <HeaderStyle Width="20px"></HeaderStyle>
                    </RowIndicatorColumn>
                    <ExpandCollapseColumn>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn UniqueName="ValidationSortable" ItemStyle-Width="30px">
                         <ItemTemplate>
                          <asp:Image ID="ValidationSortable" CssClass="SortItems" runat="server" ImageUrl="~/DesktopModules/LiveForms/Resources/Images/Sortable.png"
                           Style="cursor: move"></asp:Image>
                         </ItemTemplate>
                         </telerik:GridTemplateColumn>
                         <telerik:GridTemplateColumn DataField="GUID" ItemStyle-Width="30px">
                          <ItemTemplate>
                          <asp:ImageButton OnClick="ValidationEditState_Click" ID="ValidationEdit" runat="server"
                          ImageUrl="~/DesktopModules/LiveForms/Resources/Images/Edit.gif"></asp:ImageButton>
                           </ItemTemplate>
                           </telerik:GridTemplateColumn>
                        <telerik:GridButtonColumn ItemStyle-Width="20px" CommandName="Delete" Text="Delete"
            ...
            <telerik:radgrid id="gvActions" style="width: 99%; overflow-x: auto;" runat="server"
                ...
                <mastertableview datakeynames="GUID" nomasterrecordstext="Looks like you have not created any action!">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn ItemStyle-Width="100px" HeaderText="Execute" DataField="Execute">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn ItemStyle-Width="100px" HeaderText="Condition" DataField="ConditionSet">
                        </telerik:GridBoundColumn>
                        <telerik:GridTemplateColumn UniqueName="Sortable" ItemStyle-Width="30px">
