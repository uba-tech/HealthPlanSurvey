<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExtensionLicenseManager.ascx.cs"
    Inherits="Mandeeps.DNN.Modules.LiveForms.Licensing.ExtensionLicenseManager" %>
    <style type="text/css">
    .MNormal
    {
