<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExtensionActivationManager.ascx.cs"
    Inherits="Mandeeps.DNN.Modules.LiveForms.Licensing.ExtensionActivationManager" %>
<style type="text/css">
    a.mbutton
    {
