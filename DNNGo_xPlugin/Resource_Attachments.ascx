<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_Attachments.ascx.cs" Inherits="DNNGo.Modules.xPlugin.Resource_Attachments" %>
<div class="container">
 <div class="row">
        <div class="col-sm-8">
        ...
        <div class="col-sm-8">
           <ul id="paginator-ArticleList" class="pagination-purple"></ul>
            ...
            function ReturnAlbum(PictureUrl, PictureID) {
               ...
               window.parent.$('#AddAtachments_Modal').modal('hide');
            }
            ...
            function ReturnAttachments() {
                ...
                $("input[type='checkbox'][title]:checked").each(function (index, domEle) { 
                 ...
                 if (!checkok) {
                    ...
                    window.parent.ShowAttachments(PictureUrls, PictureIDs,PictureNames);
                    window.parent.$('#AddAtachments_Modal').modal('hide');
                 }
                return false;
            }
