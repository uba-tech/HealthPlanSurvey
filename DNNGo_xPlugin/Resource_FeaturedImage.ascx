<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_FeaturedImage.ascx.cs" Inherits="DNNGo.Modules.xPlugin.Resource_FeaturedImage" %> 
<div class="container">
    <div class="row">
        <div class="col-sm-8">
             ...
             <asp:GridView ID="gvArticleList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvArticleList_RowDataBound" OnRowCreated="gvArticleList_RowCreated" OnSorting="gvArticleList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action" ItemStyle-CssClass="center">
                                <ItemTemplate>
                                     <asp:HyperLink Target="_blank" runat="server" ID="hlAdd" Text="Add" CssClass="btn btn-xs btn-primary tooltips"></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
      ...
      <!-- end--> 
            ...
            <script type="text/javascript">
                ...
                function ReturnPicture(PictureUrl, PictureID) {
                    ...
                    window.parent.$('#AddPicture_Modal').modal('hide');
                }
