<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View_Index.ascx.cs" Inherits="DNNGo.Modules.xPlugin.View_Index" %>
...
<asp:Panel ID="panNavigation" runat="server"  CssClass="Navigation">
    <asp:HyperLink ID="hlManager" runat="server" CssClass="xPlugin_Manager" Text="<i class='icon-file'></i> Manager" resourcekey="Actions_Manager" Target="_blank"></asp:HyperLink>
</asp:Panel>
