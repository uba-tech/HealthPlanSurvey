<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resource_Attachments.aspx.cs" Inherits="DNNGo.Modules.xPlugin.Resource_Attachments1" %>
<%@ Register src="Resource_DropzoneUpload.ascx" tagname="Resource_DropzoneUpload" tagprefix="uc1" %>
<%@ Register src="Resource_Attachments.ascx" tagname="Resource_Attachments" tagprefix="uc2" %>
<!DOCTYPE HTML>
<!--
/*
...
<div class="tabbable">
  <ul id="myTab4" runat="server" class="nav nav-tabs tab-bricky">
    <li id="liNavigation_add" runat="server"><asp:HyperLink ID="hlNavigation_add" runat="server" Text="<i class='fa fa-plus'></i> Add Attachments" ></asp:HyperLink></li>
    <li id="liNavigation_list" runat="server"> <asp:HyperLink ID="hlNavigation_list" runat="server" Text="<i class='fa clip-list-4'></i> Attachment list" ></asp:HyperLink></li>
  </ul>
  <div class="tab-content">
    ...
    <asp:Panel ID="panel_tab3_example2" runat="server" CssClass="tab-pane">
        ...
        <asp:PlaceHolder ID="phAttachments" runat="server"></asp:PlaceHolder>
            <%--<uc2:Resource_Attachments ID="Resource_Attachments2" runat="server" />--%>
        </form>
     </asp:Panel>
  </div>
</div>
