<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resource_GalleryImage.aspx.cs" Inherits="DNNGo.Modules.xPlugin.Resource_GalleryImage1" %>
<%@ Register src="Resource_DropzoneUpload.ascx" tagname="Resource_DropzoneUpload" tagprefix="uc1" %>
<%@ Register src="Resource_GalleryImage.ascx" tagname="Resource_GalleryImage" tagprefix="uc2" %>
<!DOCTYPE HTML>
<!--
/*
        ...
        <div class="tabbable">
          ...
          <div class="tab-content">
            ...
            <asp:Panel ID="panel_tab3_example2" runat="server" CssClass="tab-pane">
                  ...
                  <asp:PlaceHolder ID="phGalleryImage" runat="server"></asp:PlaceHolder>
                  <%--<uc2:Resource_GalleryImage ID="Resource_GalleryImage2" runat="server" />--%></form>
            </asp:Panel>
          </div>
        </div>
</body> 
