...
(function ($) {
    ...
    $.widget('blueimp.fileupload', {
        ...
        options: {
            ...
            // Add form data to be sent along with the file uploads can be set
            ...
            // data.submit() returns a Promise object and allows to attach Add
        ...
        // must have a files property and can contain Add options:
