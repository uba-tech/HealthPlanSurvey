...
using UBA.Modules.HealthPlanSurvey.Components;
...
namespace UBA.Modules.HealthPlanSurvey
{
    ...
    /// 
    /// Because the control inherits from HealthPlanSurveyModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Edit : HealthPlanSurveyModuleBase
    {
